 ...
 *                                     Should be passed as full or relative path to module file.
...
var caching = function(args) {
    ...
    if (typeof args.store === 'object') {
        ...
        var storeName = args.store || './stores/memory';
        storeName = 'memory' ? './stores/memory' : storeName;
        self.store = require(storeName).create(args);
    }
